...
/**
 * The core workload which allows antimatters and delay for every operation.
 */
public class CoreWorkloadWithAntimatter extends Workload {
  /**
  ...
  /**
   * Percentage of anti-matters.
   */
  public static final String ANTIMATTER_FRACTION = "antimatterfraction";
  ...
  public static final String OPERATION_DELAY_DEFAULT = "0,0";
  ...
  public void init(Properties p) throws WorkloadException {
    ...
    fieldlengthgenerator = CoreWorkloadWithAntimatter.getFieldLengthGenerator(p);
  ...
  /**
   * Delay before every operation.
   * @return false if interrupted, else true (including no delay).
   */
